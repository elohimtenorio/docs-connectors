...
The Anypoint Connector for File (File Connector) manipulates file systems mounted on a host operation system.
...
If the flow never accesses the content of the file, the check is not done. Also,
