...
Anypoint Connector for FTPS (FTPS Connector) connects to FTP servers the same way as the xref:ftp/ftp-connector.adoc[FTP connector] but adds support for xref:4.1@mule-runtime::tls-configuration.adoc[Transport Layer Security (TLS)].
...
<dependency>
    ...
    <version>RELEASE</version> <!-- or later -->
