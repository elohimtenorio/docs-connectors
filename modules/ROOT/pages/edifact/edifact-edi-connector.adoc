...
. In Exchange, search for "edifact".
...
. In *Add Modules to Project*, type "edifact" in the search field.
...
image::edifact/edifact-edi-general.jpg[General tab properties]
...
image::edifact/edifact-edi-identity.jpg[Identity tab properties]
...
image::edifact/edifact-edi-parser.jpg[Parser tab properties]
...
image::edifact/edifact-edi-writer.jpg[Writer tab properties]
...
image::edifact/edifact-edi-mapping-flow.jpg[Mapping Flow Diagram]
...
image::edifact/edifact-edi-ack-flow.jpg[Ack Flow Diagram]
