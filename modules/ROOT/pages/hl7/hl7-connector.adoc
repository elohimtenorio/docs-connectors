...
Release Notes: xref:release-notes::connector/hl7-connector-release-notes-mule-4.adoc[HL7 EDI Connector Release Notes]
...
image::hl7/hl7-connector-flow-in-studio.png[Example flow in Studio]
...
* xref:hl7/hl7-schemas.adoc[HL7 Supplied Schemas]
* https://help.mulesoft.com[MuleSoft Help Center]
* xref:1.0@partner-manager::edi-schema-language-reference.adoc[EDI Schema Language]
