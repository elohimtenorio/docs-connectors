= Microsoft Dynamics 365 - Examples - Mule 4
...
. Add Microsoft Dynamics 365 Update operation
...
. The entity Id is required attribute to know which entity instance will be updated.
...
Dissasociates entities. You provide the ID of the entity upon which the request will be made and the keys that will be dissasociated. +
