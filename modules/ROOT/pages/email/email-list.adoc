= List Emails with the Email Connector - Mule 4
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Email Connector can list emails from any part of the flow. (Note that this capability is a change from the Mule 3 transport, which could only retrieve emails as a result of inbound endpoint polling.)
